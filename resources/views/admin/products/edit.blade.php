    ...
    <div class="container">
      ...
      <div class="section ">
        ...
        <div class="row">
          ...
          <textarea class="form-control" placeholder="Descripcion completa del producto" rows="5" name="long_description">{{ $product->long_description }}</textarea>

          <button  class="btn btn-primary">Guardar cambios producto</button>
